        ...
        return (
            <>
                ...
                <div className="column-2 box">
                    ...
                    <p>
                        ...
                        The model was pretrained on the 0xford-IIIT Pets Dataset. <br/>
            ...
            <div style={{display: 'flex', alignContent: 'center'}} >
                <figure>
                    ...
                    <figcaption className="ssd">Figure 1: Architecture of the SSD feed-forward convolutional network with a 512 x 512 input size</figcaption>
                </figure>
